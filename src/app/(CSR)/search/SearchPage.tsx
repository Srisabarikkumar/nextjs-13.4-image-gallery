...
import { Alert, Button, Form, FormControl, FormGroup, FormLabel, Image, Spinner } from "react-bootstrap";
...
export default function SearchPage() {
  ...
  return (
    <div>
      <Alert>
        This page fetches data <strong>client-side</strong>. In order to not leak API credentials, the request is sent 
        to a NextJS <strong>route handler</strong> that runs on the server. This route handler then fetches the data from the Unsplash 
